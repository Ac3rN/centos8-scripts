...
# Updates CentOS local repositories on this box.
dnf update -y

# Installs Clamav and Clamav-Update
...
lukas    1608  1581  0 17:13 pts/0    00:00:00 grep --color=auto clam
[lukas@rockyos ~]$ 
'
